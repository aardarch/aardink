...
- [ ] `./gradlew :editor:spotlessCheck` passes
- [ ] `./gradlew :editor:lint` passes
- [ ] `./gradlew :editor:test` passes
- [ ] `./gradlew :editor:apiCheck` passes
- [ ] If the public API changed, ran `./gradlew :editor:apiDump` and committed `editor/api/editor.api`
